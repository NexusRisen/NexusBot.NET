...
public class KookSettings
{
    ...
    public enum KookEmbedColorOption
    {
        Blue,
    ...
    public enum KookThumbnailOption
    {
        Gengar,
    ...
    public KookAnnouncementSettingsCategory AnnouncementSettings { get; set; } = new();

    [Category(Startup), Description("Indicates the Kook presence status color only considering bots that are Trade-type."), DisplayName("Status Color Trade Change")]
    ...
    [Category(Startup), Description("List of modules that not be loaded when the bot is started (comma separated)."), DisplayName("Module Blacklist")]
    ...
    [Category(Operation), TypeConverter(typeof(CategoryConverter<KookAnnouncementSettingsCategory>))]
    public class KookAnnouncementSettingsCategory
    {
        public KookEmbedColorOption AnnouncementEmbedColor { get; set; } = KookEmbedColorOption.Purple;

        [Category("Embed Settings"), Description("Thumbnail option for announcements.")]
        public KookThumbnailOption AnnouncementThumbnailOption { get; set; } = KookThumbnailOption.Gengar;
