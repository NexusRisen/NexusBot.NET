...
public class StoatSettings
{
    ...
    public enum StoatEmbedColorOption
    {
        Blue,
    ...
    public enum StoatThumbnailOption
    {
        Gengar,
    ...
    [Category(Startup), Description("Bot login token."), DisplayName("Stoat Bot Token")]
    ...
    public StoatAnnouncementSettings AnnouncementSettings { get; set; } = new();

    [Category(Startup), Description("Indicates the Stoat presence status color only considering bots that are Trade-type."), DisplayName("Status Color Trade Change")]
    ...
    [Category(Users), Description("Comma separated Stoat user IDs that will have sudo access to the Bot Hub."), DisplayName("Global Sudo List")]
    ...
    public StoatAISettings AISettings { get; set; } = new();

    public override string ToString() => "Stoat Integration Settings";

    [Category(AICategory), TypeConverter(typeof(CategoryConverter<StoatAISettings>))]
    public class StoatAISettings
    {
    ...
    [Category(Operation), TypeConverter(typeof(CategoryConverter<StoatAnnouncementSettings>))]
    public class StoatAnnouncementSettings
    {
        public StoatEmbedColorOption AnnouncementEmbedColor { get; set; } = StoatEmbedColorOption.Purple;

        [Category("Embed Settings"), Description("Thumbnail option for announcements.")]
        public StoatThumbnailOption AnnouncementThumbnailOption { get; set; } = StoatThumbnailOption.Gengar;
