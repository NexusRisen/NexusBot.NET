...
public class RemoteControlBotBS(PokeBotState Config, PokeTradeHub<PKHeX.Core.PB8> Hub) : PokeRoutineExecutor8BS(Config)
{
    public PokeTradeHub<PKHeX.Core.PB8> Hub { get; } = Hub;
