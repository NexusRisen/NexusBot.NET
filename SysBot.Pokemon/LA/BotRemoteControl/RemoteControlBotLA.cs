...
public class RemoteControlBotLA(PokeBotState Config, PokeTradeHub<PKHeX.Core.PA8> Hub) : PokeRoutineExecutor8LA(Config)
{
    public PokeTradeHub<PKHeX.Core.PA8> Hub { get; } = Hub;
