...
public class RemoteControlBotSWSH(PokeBotState Config, PokeTradeHub<PKHeX.Core.PK8> Hub) : PokeRoutineExecutor8SWSH(Config)
{
    public PokeTradeHub<PKHeX.Core.PK8> Hub { get; } = Hub;
