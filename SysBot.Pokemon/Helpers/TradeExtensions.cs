...
namespace SysBot.Pokemon.Helpers
{
    public abstract class TradeExtensions<T> where T : PKM, new()
    {
        ...
        public static bool HasAdName(T pk, out string ad)
        {
            ...
            bool ot = pk.OriginalTrainerName != null && Regex.IsMatch(pk.OriginalTrainerName, domainPattern, RegexOptions.IgnoreCase);
            bool nick = pk.Nickname != null && Regex.IsMatch(pk.Nickname, domainPattern, RegexOptions.IgnoreCase);
