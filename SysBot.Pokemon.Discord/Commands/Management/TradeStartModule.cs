...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
            ...
            string ballImgUrl = SysBot.Pokemon.Helpers.AssetManager.GetAssetUrl("Balls/Alt/28x28/difficulty.png");
            ...
            if (detail.TradeData != null && detail.Type != PokeTradeType.Clone && detail.Type != PokeTradeType.Dump && detail.Type != PokeTradeType.Seed && detail.Type != PokeTradeType.FixOT)
            {
                ...
                ballImgUrl = SysBot.Pokemon.Helpers.AssetManager.GetAssetUrl($"Balls/Alt/28x28/{ballName}.png");
            }
            ...
            string embedImageUrl = detail.IsMysteryEgg ? SysBot.Pokemon.Helpers.AssetManager.GetAssetUrl("Assets/Eggs/mysteryegg3.png") : detail.Type switch
            {
                PokeTradeType.Clone => SysBot.Pokemon.Helpers.AssetManager.GetAssetUrl("Assets/Bot/Actions/Cloning.png"),
                PokeTradeType.Dump => SysBot.Pokemon.Helpers.AssetManager.GetAssetUrl("Assets/Bot/Actions/Dumping.png"),
                PokeTradeType.FixOT => SysBot.Pokemon.Helpers.AssetManager.GetAssetUrl("Assets/Bot/Actions/FixOTing.png"),
                PokeTradeType.Seed => SysBot.Pokemon.Helpers.AssetManager.GetAssetUrl("Assets/Bot/Actions/Seeding.png"),
